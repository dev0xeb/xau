"""
London/NY Overlap 1-Trade-Per-Day Precision Micro-Intraday Engine for Gold (XAU/USD).

Execution Rules:
1. Max 1 Trade Per Day during the London/NY Overlap Window (12:00 - 16:00 UTC).
2. Entry Trigger: 15m Liquidity Sweep + 5m FVG Displacement Gap (>= $1.00).
3. Target: Opposing 15m Supply/Demand Zone or Range Extreme.
4. Invalidation SL: $1.20 past liquidity sweep wick.
5. Dynamic 1% Risk Sizing ($100 on $10k).
"""
...
def run_overlap_1trade_per_day():
    ...
    for d in target_dates:
        ...
        for i in range(15, n - 12):
            ...
            hour = hours_5m[i]
            # OVERLAP WINDOW: 12:00 - 16:00 UTC ONLY
            if not (12 <= hour < 16):
                continue
    ...
    print("=" * 95)
    print(" OVERLAP 1-TRADE-PER-DAY MICRO-INTRADAY REPORT (AUG 3 - AUG 10, 2026)")
    print("=" * 95)
    ...
    print("\n" + "-" * 95)
    print(" EXECUTED 1-TRADE-PER-DAY LOG (PAST WEEK):")
    print("-" * 95)
