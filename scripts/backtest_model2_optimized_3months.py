"""
Model 2: Optimized M5 Scalp Hybrid Strategy Engine (3-Month Backtest: May 10 - Aug 10, 2026).

3-Month Out-of-Sample Evaluation across 65 Trading Days / 18,046 5-minute candles.

Implements all 10 Blueprint steps + 2 Microstructure Filters:
1. Closed Candle Indexing (iloc[-2])
2. Commercial Session Window Filter (07:00 - 17:00 UTC)
...
8. Max EMA Extension Filter (abs(Entry - M5 EMA21) <= $3.00)
"""
...
def run_model2_3m_backtest():
    ...
    for i in range(10, n - 24):
        ...
        # STEP 2: Session Window Filter (07:00 - 17:00 UTC)
        if not (7 <= hr < 17):
            continue
        ...
        # STEP 4: M5 FVG Displacement Calculation
        ...
        # STEP 5: Institutional Liquidity Sweep
        ...
        # OPTIMIZED FILTER: Max EMA Extension Filter (abs(Entry - M5 EMA21) <= $3.00)
        if bull_signal:
        ...
        # STEP 7: Structural Entry, Dynamic SL & 3-Burst Target Matrix
    ...
    print("=========================================================================================")
    print(f" OPTIMIZED MODEL 2: 3-MONTH OUT-OF-SAMPLE REPORT (MAY 10 - AUG 10, 2026) [{elapsed:.2f}s]")
    print("=========================================================================================")
    ...
    print(f"  Total Executed Trades:    {n_tr} Trades (~{n_tr/65:.1f} trades / day | ~{n_tr/13:.1f} trades / week)")
    print(f"  Win Rate:                 {wr:.1f}% ({wins} Wins / {n_tr - wins} Losses)")
    print(f"  Profit Factor:            {pf:.2f}")
    print(f"  Max Drawdown:             -{max_dd:.2f}%")
    print(f"  Average SL Distance:      {avg_sl:.1f} pips (${avg_sl*0.10:.2f})")

if __name__ == "__main__":
    run_model2_3m_backtest()
