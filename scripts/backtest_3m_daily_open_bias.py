"""
Ultra-Rigorous 3-Month Backtest for Model 2: Daily Open Bias Overlap Model.
...
4. Daily Session Bias: Evaluated strictly against Midnight Open ($00:00 UTC) at or before candle `i`.
5. Max 1 Trade Per Day during Overlap Session (12:20 - 15:30 UTC).
...
def run_3m_daily_open_bias():
    ...
    for d in target_dates:
        ...
        # NO LOOKAHEAD: Midnight open price defined strictly at 00:00 UTC
    ...
    print("=" * 95)
    print(f" MODEL 2: DAILY OPEN BIAS OVERLAP 3-MONTH RIGOROUS REPORT (MAY 10 - AUG 10, 2026) [{elapsed:.2f}s]")
    print("=" * 95)
    ...
    print("\n" + "-" * 95)
    print(" SAMPLE EXECUTED TRADES LOG (MODEL 2):")
    print("-" * 95)
