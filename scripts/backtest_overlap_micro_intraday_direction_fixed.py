"""
Corrected London/NY Overlap Micro-Intraday Strategy Engine for Gold (XAU/USD).

Enforces Candle Direction Confirmation:
- BUY: Low < prev_15m_low AND 5m Candle Closes BULLISH (close > open)
- SELL: High > prev_15m_high AND 5m Candle Closes BEARISH (close < open)
"""
...
def run_overlap_micro_direction_fixed():
    ...
    for d in target_dates:
        ...
        for i in range(15, n - 12):
            ...
            # Bullish Sweep + Bullish Close
            bull_sweep = (c_low < prev_15m_low) and (c_close > c_open)

            # Bearish Sweep + Bearish Close
    ...
    print("=" * 95)
    print(" OVERLAP MICRO-INTRADAY DIRECTION-FIXED WEEKLY REPORT (AUG 3 - AUG 10, 2026)")
    print("=" * 95)
...
if __name__ == "__main__":
    run_overlap_micro_direction_fixed()
